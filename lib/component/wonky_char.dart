...
class WonkyCharState extends State<WonkyChar> with SingleTickerProviderStateMixin {
  ...
  late Animation _rotationAnimation = Tween<double>(begin: 0, end: 0).animate(defaultCurve);
  late Animation _colorAnimation = ColorTween(begin: Colors.black, end: Colors.black).animate(defaultCurve);
  ...
  Widget build(BuildContext context) {
    ...
    return Transform(
      ...
      transform: Matrix4.translationValues(_offsetXAnimation.value as double, _offsetYAnimation.value as double, 0)
      ...
      if (s.type == 'fv') {
        ...
        switch (s.property) {
          ...
          default:
            {
              if (kDebugMode) {
                print('**ERROR** unrecognized property to animate: ${s.property}');
              }
            }
        }
      }
