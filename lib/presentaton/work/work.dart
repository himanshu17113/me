  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ValueListenableBuilder<bool>(
          ...
          builder: (BuildContext context, bool down, Widget? child) => ListView(
                  ...
                  child: MouseRegion(
                    ...
                    child: VectorGraphic(
                      ...
                      colorFilter: ColorFilter.mode(
                          _isHovered ? theme.colorScheme.primaryContainer : theme.colorScheme.inverseSurface, BlendMode.srcIn),
                      height: mediaQueryData.size.width * 0.16,
